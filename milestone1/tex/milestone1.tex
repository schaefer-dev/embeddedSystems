...
After the proximity sensor reads a value above the predetermined threshold, it puts the signal through to the Controller. Here we get an interrupt, which in turn leads to changing the orientation of our collector robot to the direction of sensed object. 
\end{itemize} 
