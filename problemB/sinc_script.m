...
v0 = sample_function(0*frequency);
v1 = sample_function(1*frequency);
v2 = sample_function(2*frequency);
v3 = sample_function(3*frequency);
v4 = sample_function(4*frequency);
v5 = sample_function(5*frequency);
v6 = sample_function(6*frequency);
v7 = sample_function(7*frequency);
v8 = sample_function(8*frequency);
v9 = sample_function(9*frequency);
v10 = sample_function(10*frequency);
v11 = sample_function(11*frequency);
v12 = sample_function(12*frequency);
v13 = sample_function(13*frequency);
v14 = sample_function(14*frequency);
v15 = sample_function(15*frequency);
v16 = sample_function(16*frequency);
...
plot(t_o, g); hold on; plot(t_o, f_original); stairs(t_s, f_sampled) ;legend('g','signal', 'sample points');
