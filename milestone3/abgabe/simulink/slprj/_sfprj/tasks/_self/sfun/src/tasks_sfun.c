...
uint32_T _tasksMachineNumber_;

/* Function Declarations */

/* Function Definitions */
void tasks_initializer(void)
{
}

void tasks_terminator(void)
{
}

/* SFunction Glue Code */
unsigned int sf_tasks_method_dispatcher(SimStruct *simstructPtr, unsigned int
...
unsigned int sf_tasks_process_check_sum_call( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1344572156U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3777940899U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3059921490U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(857618682U);
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(586443030U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1231095569U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4235054368U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4044916726U);
  }
...
unsigned int sf_tasks_autoinheritance_info( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 3:
      {
        if (strcmp(aiChksum, "vKA9varQCRDXUoaJBGmRUC") == 0) {
...
unsigned int sf_tasks_get_eml_resolved_functions_info( int nlhs, mxArray * plhs[],
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 3:
      {
        if (strcmp(instanceChksum, "ssGE2ddFI3rKIIPVdPKZvHH") == 0) {
...
unsigned int sf_tasks_third_party_uses_info( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 3:
      {
        if (strcmp(tpChksum, "ssGE2ddFI3rKIIPVdPKZvHH") == 0) {
...
unsigned int sf_tasks_jit_fallback_info( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...
unsigned int sf_tasks_updateBuildInfo_args_info( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...
void tasks_debug_initialize(struct SfDebugInstanceStruct* debugInstance)
{
  _tasksMachineNumber_ = sf_debug_initialize_machine(debugInstance,"tasks",
    "sfun",0,4,0,0,0);
  sf_debug_set_machine_event_thresholds(debugInstance,_tasksMachineNumber_,0,0);
  sf_debug_set_machine_data_thresholds(debugInstance,_tasksMachineNumber_,0);
}

void tasks_register_exported_symbols(SimStruct* S)
{
}
...
void unload_tasks_optimization_info(void);
mxArray* load_tasks_optimization_info(boolean_T isRtwGen, boolean_T isModelRef,
  boolean_T isExternal)
{
  ...
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info("tasks", "tasks");
