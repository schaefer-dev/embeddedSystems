...
static const char * c3_debug_family_names[8] = { "current_task_c", "nargin",
  "nargout", "clock_c", "running_task_c", "finished_prev_task_c",
...
static void sf_gateway_c3_tasks(SFc3_tasksInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_clock_c, 0U);
  chartInstance->c3_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  c3_hoistedGlobal = *chartInstance->c3_clock_c;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 2U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_b_clock_c, 3U, c3_sf_marshallOut);
  ...
  if (CV_EML_IF(0, 1, 0, CV_RELATIONAL_EVAL(4U, 0U, 0, c3_b_clock_c, 0.0, -1, 0U,
        c3_b_clock_c == 0.0))) {
...
static void init_simulink_io_address(SFc3_tasksInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_clock_c = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2357600953U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1030014572U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(478489723U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1088692329U);
}
...
mxArray *sf_c3_tasks_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("vKA9varQCRDXUoaJBGmRUC");
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"clock_c");
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,235,252,-1,298);
        _SFD_CV_INIT_EML_IF(0,1,1,414,444,-1,548);
        _SFD_CV_INIT_EML_IF(0,1,2,590,653,-1,707);

        {
          static int condStart[] = { 594, 617 };

          static int condEnd[] = { 613, 652 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,594,652,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,239,251,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,1,418,443,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,2,594,613,-1,1);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,3,617,652,-1,0);
...
static void chart_debug_initialize_data_addresses(SimStruct *S)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      ...
      {
        _SFD_SET_DATA_VALUE_PTR(0U, (void *)chartInstance->c3_clock_c);
...
{
  return "ssGE2ddFI3rKIIPVdPKZvHH";
}
...
static void mdlSetWorkWidths_c3_tasks(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3538556243U));
  ssSetChecksum1(S,(3988521539U));
  ssSetChecksum2(S,(1564057300U));
  ssSetChecksum3(S,(304911042U));
