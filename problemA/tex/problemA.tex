...
\begin{enumerate}[a)]
  ...
  \item
    ...
    \includegraphics[scale = 0.29]{pictures/model4}\\
      ...
      the falling line represents the decreasing y coordinate of the ball in its fall and the rising line shows the increasing distance to the table edge in X direction.\\
